...
function requestOrigin(reqHeaders) {
...
function startHandler(authService) {
    return async (ctx) => {
...
function callbackHandler(authService) {
    return async (ctx) => {
        ...
        if (!code || !state) {
            throw new HttpError(400, "INVALID_OAUTH_CALLBACK", "OAuth callback must include code and state query parameters.");
        }
